...
from webullpaysdkmdata.quotes.grpc.pb import quote_pb2
from webullpaysdkmdata.quotes.grpc.response import Response
from webullpaysdkmdata.quotes.subscribe.snapshot_decoder import SnapshotDecoder
from webullpaysdkmdata.quotes.subscribe.tick_decoder import TickDecoder
from webullpaysdkmdata.quotes.subscribe.quote_decoder import QuoteDecoder
from webullpaysdkmdata.quotes.subscribe.payload_type import (PAYLOAD_TYPE_QUOTE,
                                                          PAYLOAD_TYPE_SHAPSHOT, PAYLOAD_TYPE_TICK)
from webullpaysdkmdata.request.grpc.get_streaming_token_request import GetStreamingTokenRequest
from webullpaysdkmdata.request.grpc.quotes_subscribe_request import SubscribeRequest
from webullpaysdkmdata.request.grpc.quotes_unsubscribe_request import UnsubcribeRequest
...
if __name__ == '__main__':
    ...
    try:
        # subscribe
        res = custom_client.subscribe(['BTCUSD'], Category.CRYPTO.name,
    ...
    print("unsubscribe")
    res = custom_client.unsubscribe(symbols=['BTCUSD'], category=Category.CRYPTO.name,
